...
public class LabelsAndTexts3D extends Node {
	...
	private void updateGui() {
		...
		org.godot.node.Node name2 = getNode("Testers/Label3DHealthBar/Name2");
		org.godot.node.LineEdit lineEdit = (org.godot.node.LineEdit) getNode("Testers/Label3DHealthBar/LineEdit");
