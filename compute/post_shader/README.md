...
`PostProcessShader.java` shows an example where a template shader is used into which user code
...
`PostProcessGrayscale.java` shows an example where the shader code is stored in a file,
