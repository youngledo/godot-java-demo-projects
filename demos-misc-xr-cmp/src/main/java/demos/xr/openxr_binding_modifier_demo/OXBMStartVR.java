...
@GodotClass(name = "OXBMStartVR", parent = "Node3D")
public class OXBMStartVR extends Node3D {
    ...
    public void _ready() {
        ...
        if (xrInterface != null && (boolean) xrInterface.call("is_initialized")) {
            ...
            org.godot.singleton.DisplayServer.singleton().call("window_set_vsync_mode", 1); // VSYNC_DISABLED
            ...
            if (renderingServer != null && renderingServer.call("get_rendering_device") != null) {
                ...
                org.godot.Godot projectSettings = (org.godot.Godot) call("get_setting", "xr/openxr/foveation_level");
                // Note: can't easily check project settings value here, just warn
            }
    ...
    public void _on_openxr_visible_state() {
        if (xrIsFocused) {
            ...
            xrIsFocused = false;
            setProperty("process_mode", 3); // PROCESS_MODE_DISABLED
        }
    }
    ...
    public void _on_openxr_focused_state() {
        ...
        xrIsFocused = true;
        setProperty("process_mode", 0); // PROCESS_MODE_INHERIT
    }
    ...
    public void _on_openxr_pose_recentered() {
        // Pose recentered signal - game implementation dependent.
    }
}
